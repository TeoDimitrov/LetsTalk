...
public class TimeFrameRepository {
    ...
    public void save(TimeFrame timeFrame) {
        ...
        keyBuilder.append(timeFrame.getStartDateTime());
        keyBuilder.append(timeFrame.getEndDateTime());
        keyBuilder.append(timeFrame.getType());
    ...
    public List<TimeFrame> findByAdvisorName(String advisorName) {
        final List<com.wecode.letstalk.domain.timeFrames.TimeFrame> timeFrames = new ArrayList<>();
        ...
        query.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    for (DataSnapshot timeFrameChild : dataSnapshot.getChildren()) {
                        com.wecode.letstalk.domain.timeFrames.TimeFrame timeFrame = timeFrameChild.getValue(com.wecode.letstalk.domain.timeFrames.TimeFrame.class);
                        timeFrames.add(timeFrame);
                    }
                }
            }
