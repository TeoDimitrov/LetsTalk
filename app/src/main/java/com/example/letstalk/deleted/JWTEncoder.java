package com.example.letstalk.deleted;
...
/**
 * Created by teodo on 09/10/2016.
 */
public class JWTEncoder {
    ...
    private static String encodeJson(JSONObject jsonData) {
        return Base64.encodeToString(jsonData.toString().getBytes(UTF8_CHARSET),Base64.DEFAULT).replace('+','-').replace('/','_');
    }
}
